        ...
        try:
            ...
            while True:
                ...
                for contour in contours:
                    if cv2.contourArea(contour) > 2500:
                        x, y, w, h = cv2.boundingRect(contour)
                        cv2.rectangle(dilated_frame, (x, y), (x + w, y + h), (255, 255, 255), -1)
...
button_image_1 = PhotoImage(
    file=relative_to_assets("btn_1.png"))
button_1 = Button(
...
button_image_2 = PhotoImage(
    file=relative_to_assets("btn_2.png"))
button_2 = Button(
...
button_image_3 = PhotoImage(
    file=relative_to_assets("btn_3.png"))
button_3 = Button(
...
button_image_4 = PhotoImage(
    file=relative_to_assets("btn_4.png"))
button_4 = Button(
...
button_image_5 = PhotoImage(
    file=relative_to_assets("btn_5.png"))
button_5 = Button(
...
button_image_6 = PhotoImage(
    file=relative_to_assets("btn_6.png"))
button_6 = Button(
...
button_image_7 = PhotoImage(
    file=relative_to_assets("btn_7.png"))
button_7 = Button(
...
button_image_8 = PhotoImage(
    file=relative_to_assets("btn_8.png"))
button_8 = Button(
...
button_image_9 = PhotoImage(
    file=relative_to_assets("btn_9.png"))
button_9 = Button(
